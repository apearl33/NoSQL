...
mongoose.connect('mongodb://10.92.128.28:27017/blogger', { useNewUrlParser: true });
...
//STORE
app.post('/blogs/add',
[check('title').not().isEmpty().withMessage('Title is a required field.'), check('slug').not().isEmpty().withMessage('Slug is a required field.'), check('body').not().isEmpty().withMessage('Body is a required field.'), check('comment').not().isEmpty().withMessage('Comment is a required field.'), check('category').not().isEmpty().withMessage('Category is a required field.')], async function(req, res){
...
//UPDATE
app.put('/blogs/edit/:_id', [check('title').not().isEmpty().withMessage('Title is a required field.'), check('slug').not().isEmpty().withMessage('Slug is a required field.'), check('body').not().isEmpty().withMessage('Body is a required field.')], async function(req, res){
